...
// This script is edited by tippy3
...
var Lemmatizer = function() {
  this.wn_files = {
    noun: [
      'js/javascript-lemmatizer-master/dict/index.noun.json',
      'js/javascript-lemmatizer-master/dict/noun.exc.json'
    ],
    verb: [
      'js/javascript-lemmatizer-master/dict/index.verb.json',
      'js/javascript-lemmatizer-master/dict/verb.exc.json'
    ],
    adj:  [
      'js/javascript-lemmatizer-master/dict/index.adj.json',
      'js/javascript-lemmatizer-master/dict/adj.exc.json'
    ],
    adv:  [
      'js/javascript-lemmatizer-master/dict/index.adv.json',
      'js/javascript-lemmatizer-master/dict/adv.exc.json'
    ]
  };
...
Lemmatizer.prototype = {
  ...
  open_file: function(key, file) {
    if (!localStorage.getItem("chrome-extension-ytd-"+key)) {
      const target_url = chrome.extension.getURL(file);
      fetch(target_url).then((res)=>{
        return res.json();
      }).then((myJson)=>{
        this.store_data( key, JSON.stringify(myJson) );
      });
